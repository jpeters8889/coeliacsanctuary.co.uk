...
@section('content')
    ...
    <div class="inner-wrapper">
        ...
        <section>
            <div class="page-box mt-4">
                <h1 class="font-coeliac font-semibold text-2xl">Latest Coeliac Reviews</h1>
                <p>
                    ...
                    <a href="/wheretoeat" class="font-semibold hover:underline">Where to Eat</a> guide, and we'll always
                    try to produce a honest review detailing our experience, so you know its safe for you to eat there
                    too!
                </p>
            </div>
            <div class="grid grid-cols-1 sm:grid-cols-2 mt-2 gap-2">
                @foreach($latestReviews as $review)
                    <div class="bg-white w-full overflow-hidden flex flex-col shadow">
                        ...
                        <div class="p-2 flex flex-col h-full">
                            <a href="/review/{{ $review->slug }}" class="flex-1">
                                <h3 class="font-semibold hover:underline">{{ $review->title }}</h3>
                            </a>
