                ...
                <mj-section mj-class="blue" padding="10px">
                    <mj-column>
                        <mj-text align="center">
                            This email was sent to ::subscriber.email:: because you are signed up to the Coeliac Sanctuary mailing list.
                        </mj-text>
                        <mj-text>&nbsp;</mj-text>
                        <mj-text>We'd hate to see you go, but if you wish to unsubscribe, please
