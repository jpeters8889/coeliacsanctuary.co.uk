<template>
  <form
    class="bg-gradient-to-br from-blue/30 to-blue-light/30 p-2 rounded-lg"
  ...
  >
    <div>
      ...
      <div
        ...
        :key="index"
        class="py-4 border-b border-blue last:border-0"
      >
        <label
          class="text-blue-dark font-semibold mb-1"
          :for="input.field"
        >{{ input.label }}</label>
        <form-input
          :id="input.field"
