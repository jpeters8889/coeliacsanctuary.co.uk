<template>
  ...
  >
    ...
    <div class="md:pt-1 lg:hidden">
      ...
      <div
        ...
        v-click-outside="toggleMobileOptions"
        class="mt-2 absolute w-full left-0"
      >
  ...
  <div
    v-else
    class="md:pt-1"
    @mouseenter="isGt('md') ? showDropdown = true : null"
  ...
  >
    ...
    >
      <div
        v-if="showDropdown"
        class="transition transform absolute right-0 w-40 z-max"
      >
        <ul class="text-lg bg-white text-black mt-1 rounded-b-lg shadow-lg">
          <li
            v-if="isGt('md')"
            class="border-blue border-b hover:bg-blue-light hover:bg-opacity-50 transition-all"
          >
            <a
          ...
          <template v-else>
            <li class="border-blue border-b hover:bg-blue-light hover:bg-opacity-50 transition-all">
              <a
                class="block py-2 pl-2"
                href="/member/dashboard/scrapbooks"
              >
                My Scrapbooks
              </a>
            </li>
            ...
            <li class="border-blue border-b hover:bg-blue-light hover:bg-opacity-50 transition-all">
              <a
                class="block py-2 pl-2"
                href="/member/dashboard/daily-updates"
              >
                Daily Updates
              </a>
            </li>
