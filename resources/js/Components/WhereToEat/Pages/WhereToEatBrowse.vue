<template>
  <div
    ref="wrapper"
    class="flex-1 flex overflow-hidden max-h-full"
  >
    ...
    <div class="relative flex-1 overflow-hidden">
      <div
        class="absolute w-5/6 p-2 z-20 overflow-hidden max-w-basket-sidebar"
        :class="{'h-full': expandFilterBar,'lg:ml-14': !showSidebar}"
      >
        <div
          class="bg-white shadow overflow-hidden"
          :class="{'h-full': expandFilterBar}"
        >
          <div
          ...
          <div
            v-if="expandFilterBar"
            class="px-4 overflow-y-scroll h-full pb-12 mb-1"
          >
            ...
            <div class="border-b border-grey-off-dark py-2">
              ...
              <ul class="flex flex-col space-y-2">
                <li
                  v-for="(venueType, index) in filters.venueTypes"
                  :key="index"
                  class="flex-1 flex cursor-pointer group select-none"
            ...
            <div class="py-2">
              ...
              <ul class="flex flex-col space-y-2">
                <li
                  v-for="(feature, index) in filters.features"
                  :key="index"
                  class="flex-1 flex cursor-pointer group select-none"
...
export default {
  ...
  methods: {
    ...
    updateUrl(latLng = null, zoom = null) {
      ...
      const url = `${window.config.baseUrl}/wheretoeat/browse/${paths.join('/')}`;
