            ...
            <div class="w-full flex flex-col xs:flex-row">
                <div class="xs:w-2/3 md:w-4/5">
                    ...
                    <div class="text-xs mt-2 text-xl">
                        <wheretoeat-list-reviews v-if="place.reviews.length > 0"
                                                 :reviews="place.reviews"></wheretoeat-list-reviews>
                ...
                <div class="xs:w-1/3 md:w-1/5">
                    <wheretoeat-list-features v-if="place.features.length > 0" :features="place.features"
                                              class="xs:justify-end"></wheretoeat-list-features>
                </div>
            </div>
        </div>
    </div>
