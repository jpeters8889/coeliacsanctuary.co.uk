<template>
    <div class="block bg-gradient-to-br from-blue/50 to-blue-light/50 rounded p-2 space-y-2 shadow ">
        ...
        <div class="overflow-hidden">
            ...
            >
                <div class="bg-white p-2 rounded transform" v-if="show">
                    <ul>
                        <li v-for="county in details.list"
                            ...
                            <a :href="'/wheretoeat/'+county.slug">
                                ...
                                <p v-html="countyDescription(county.name, county.details)" class="text-sm"></p>
                            </a>
                        </li>
                    </ul>
                </div>
