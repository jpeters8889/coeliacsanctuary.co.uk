<template>
    <div class="page-box" v-if="!loading && data.items.length === 0">
        <p>
            Sorry, you've got no items in your basket, why not
            <a href="/shop" class="font-semibold text-blue-dark hover:text-black transition-all">add some</a>?
        </p>
    </div>
    ...
    <div class="flex flex-col space-y-3" v-else>
        <div class="page-box">
            ...
            <button class="mb-4 -mt-2 py-2 px-4 bg-blue-light rounded-lg text-lg text-semibold w-full"
