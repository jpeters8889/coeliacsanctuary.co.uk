<template>
  <div class="flex flex-col space-y-3">
      ...
      <div class="flex relative">
        ...
        <div class="mt-auto">
          <button
            ...
            class="py-2 px-4 text-sm rounded-lg font-semibold bg-blue-light ml-2 h-12"
            :disabled="!! formData.id"
        ...
        <div
          v-if="canLookupPostcode() && displayLookup"
        ...
        >
          ...
          >
            <li
              class="p-2 border-b border-grey cursor-pointer hover:bg-grey-off-light transition-all"
    ...
    <div class="py-1 flex justify-between">
      <button
        class="py-3 px-6 rounded-lg font-semibold bg-blue-light"
        @click="goBack()"
      >
        Back...
      </button>
...
export default {
  ...
  methods: {
    ...
    updateSessionStorage() {
      const current = JSON.parse(sessionStorage.getItem('checkout-data'));
