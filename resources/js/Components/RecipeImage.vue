<template>
    <div style="padding-top: 52.5%" class="relative overflow-hidden">
        <img class="absolute overflow-hidden lazy"
             style="top: -50%; filter: blur(10px); transform: scale(1.1)" :data-src="src"
             :src="lazyLoadSrc"
             :alt="alt"/>
