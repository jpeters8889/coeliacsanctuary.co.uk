  ...
  >
    ...
    >
      ...
      >
        <div
          v-if="hasBackground"
          class="transition-all transform w-full max-w-modal-small max-h-full bg-white rounded-lg"
        >
          <div class="flex flex-col">
            <div class="flex items-center justify-between p-2">
              ...
              <div>
                <a
                  class="bg-yellow hover:bg-blue-light leading-none px-3 py-1 rounded shadow transition-all"
                  @click="search()"
                >
                  Search
                </a>
