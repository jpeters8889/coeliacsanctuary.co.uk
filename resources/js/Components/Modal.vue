<template>
    <div class="z-max fixed inset-0 w-full h-full bg-black-80 flex justify-center items-center" @click.self="close()">
        <div class="h-auto max-h-3/4 shadow p-2 border-2 border-blue-light w-auto rounded-lg bg-blue-light overflow-y-scroll"
        :class="computedClasses">
            <div class="h-full relative">
                <div class="absolute top-0 right-0 bg-white p-1 -mt-1 -mr-1 leading-none z-50 rounded border border-black cursor-pointer transition-bg"
                     @click="close()">
