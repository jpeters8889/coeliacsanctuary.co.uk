<template>
    <ul class="flex flex-wrap font-semibold leading-none justify-center" v-if="lastPage > 1">
        <li class="border border-blue-900 bg-blue-900 text-white rounded m-px cursor-pointer transition-all hover:bg-white hover:text-blue-900"
            v-if="canGoBack">
            <a class="p-2 block" @click.prevent="goTo(current - 1)">Previous</a>
        </li>

        <li class="border border-blue-900 rounded m-px cursor-pointer transition-all"
