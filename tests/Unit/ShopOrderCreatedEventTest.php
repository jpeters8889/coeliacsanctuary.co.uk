...
class ShopOrderCreatedEventTest extends TestCase
{
    ...
    /** @test */
    public function it_generates_a_key()
    {
        $this->dispatchOrder();
    ...
    /** @test */
    public function it_creates_the_payment_record()
    {
        $this->dispatchOrder();
    ...
    /** @test */
    public function it_has_the_correct_data_in_the_payment_record()
    {
        $this->dispatchOrder();
    ...
    /** @test */
    public function it_stores_the_discount_ammount_when_an_order_includes_a_discount()
    {
    ...
    /** @test */
    public function it_stores_a_record_against_the_discount_for_the_order()
    {
    ...
    /** @test */
    public function it_links_to_the_correct_payment_type()
    {
        $this->dispatchOrder();
    ...
    /** @test */
    public function it_has_a_payment_response()
    {
        $this->dispatchOrder();
    ...
    /** @test */
    public function it_has_a_correct_response_body()
    {
        $this->dispatchOrder();
    ...
    /** @test */
    public function it_marks_the_order_as_paid()
    {
        $this->dispatchOrder();
    ...
    /** @test */
    public function it_creates_a_notification_for_the_customer()
    {
        $this->dispatchOrder();
    ...
    /** @test */
    public function it_creates_a_notification_for_ally()
    {
        $this->dispatchOrder();
