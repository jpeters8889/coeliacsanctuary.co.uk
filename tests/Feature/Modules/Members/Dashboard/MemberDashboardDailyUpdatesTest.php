...
class MemberDashboardDailyUpdatesTest extends DashboardTest
{
    ...
    protected function setUp(): void
    {
        ...
        $this->blogTag = $this->create(BlogTag::class);
    }
    ...
    public function itReturnsTheUsersSubscriptionsOnTheSubscriptionListEndpoint()
    {
        ...
        $this->makeSubscribeRequest(DailyUpdateType::WTE_COUNTY, WhereToEatCounty::query()->first(), 'id');
        $this->makeSubscribeRequest(DailyUpdateType::WTE_TOWN, WhereToEatTown::query()->first(), 'id');
