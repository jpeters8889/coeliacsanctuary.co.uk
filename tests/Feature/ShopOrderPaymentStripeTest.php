...
class ShopOrderPaymentStripeTest extends TestCase
{
    ...
    /** @test */
    public function it_returns_an_initiate_payment_request_that_requires_action()
    {
    ...
    /** @test */
    public function it_returns_an_initiate_payment_request_that_is_successful()
    {
    ...
    /** @test */
    public function it_returns_an_payment_processing_request_that_requires_action()
    {
