...
class WhereToEatTest extends TestCase
{
    ...
    /** @test */
    public function it_loads_the_county_page()
    {
    ...
    /** @test */
    public function it_loads_the_venue_types_endpoint()
    {
        $this->get('/api/wheretoeat/venueTypes')->assertStatus(200);
    }

    /** @test */
    public function it_loads_the_main_wheretoeat_detail_endpoint()
    {
    ...
    /** @test */
    public function it_has_a_place_details()
    {
    ...
    /** @test */
    public function it_has_reviews_on_place_details()
    {
