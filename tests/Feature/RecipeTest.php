...
class RecipeTest extends TestCase
{
    ...
    /** @test */
    public function it_loads_the_recipe_index_page()
    {
        $this->get('/recipe')
            ->assertStatus(200)
    ...
    /** @test */
    public function it_loads_the_recipe_api_endpoint()
    {
    ...
    /** @test */
    public function it_only_shows_matching_recipes_when_filtered_by_feature()
    {
    ...
    /** @test */
    public function it_only_shows_matching_recipes_when_filtered_by_freefrom()
    {
        $visibleRecipe = $this->createRecipe(['title' => 'visible-recipe-title']);
        $hiddenRecipe = $this->createRecipe(['title' => 'hidden-recipe-title']);
    ...
    /** @test */
    public function it_only_shows_matching_recipes_when_filtered_by_meal()
    {
        $visibleRecipe = $this->createRecipe(['title' => 'visible-recipe-title']);
        $hiddenRecipe = $this->createRecipe(['title' => 'hidden-recipe-title']);
    ...
    /** @test */
    public function it_shows_recipe_content()
    {
    ...
    /** @test */
    public function it_doesnt_load_recipes_that_arent_live()
    {
