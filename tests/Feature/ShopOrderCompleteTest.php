...
class ShopOrderCompleteTest extends TestCase
{
    ...
    /** @test */
    public function it_redirects_to_the_main_shop_page_if_there_isnt_a_open_basket()
    {
    ...
    /** @test */
    public function it_lists_two_recent_blogs()
    {
        $this->setupOrder();
    ...
    /** @test */
    public function it_lists_three_recent_recipes()
    {
        $this->setupOrder();
    ...
    /** @test */
    public function it_lists_two_recent_reviews()
    {
        $this->setupOrder();
