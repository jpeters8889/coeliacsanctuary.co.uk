...
class ShopBasketAddTest extends TestCase
{
    ...
    /** @test */
    public function it_returns_success_when_sending_valid_data()
    {
        $this->makeRequest()
            ->assertStatus(200)
            ->assertJson(['data' => 'ok']);
    ...
    /** @test */
    public function it_doesnt_have_a_user_id_by_default()
    {
        $this->makeRequest();
    ...
    /** @test */
    public function it_links_the_basket_to_a_logged_in_user()
    {
