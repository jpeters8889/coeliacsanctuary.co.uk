...
class ShopOrderRequestTest extends TestCase
{
    ...
    /** @test */
    public function it_doesnt_need_the_user_info_if_a_user_is_logged_in()
    {
        $this->mockPaymentProcessor();
    ...
    /** @test */
    public function it_uses_the_current_logged_in_user()
    {
        $this->mockPaymentProcessor();
    ...
    /** @test */
    public function it_updates_the_user_address_id_field_in_the_order()
    {
        $this->mockPaymentProcessor();
    ...
    /** @test */
    public function it_can_use_a_shipping_address_already_stored_in_the_database()
    {
        $this->mockPaymentProcessor();
        $this->actingAs($user = factory(User::class)->create());
    ...
    /** @test */
    public function it_can_use_a_billing_address_already_stored_in_the_database()
    {
        $this->mockPaymentProcessor();
        $this->actingAs($user = factory(User::class)->create());
