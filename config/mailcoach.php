...
return [
     ...
     */
    'content_editor' => \Coeliac\Common\Mailcoach\Editor::class,

    /*
     * Here you can configure which template editor Mailcoach uses.
     * By default this is a text editor that highlights HTML.
     */
    'template_editor' => \Coeliac\Common\Mailcoach\Editor::class,
     ...
     */
    'redirect_unauthorized_users_to_route' => '/member/login',
    ...
    'models' => [
        ...
        'user' => \Coeliac\Modules\Member\Models\User::class,
    ...
    'livewire' => [
        ...
        'automation-mail-content' => \Spatie\Mailcoach\Http\App\Livewire\Automations\AutomationMailContentComponent::class,
        ...
        'campaign-content' => \Spatie\Mailcoach\Http\App\Livewire\Campaigns\CampaignContentComponent::class,
     ...
     */
    'editors' => [
        \Coeliac\Common\Mailcoach\Driver::class,
    ],
